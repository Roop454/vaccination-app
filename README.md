...
- Live Demo: https://vaccination-frontend.onrender.com
- Backend API: https://vaccination-app-j1kq.onrender.com/api/users
- Source Code: https://github.com/Roop454/vaccination-app
...
Backend service URL for this project:
`https://vaccination-app-j1kq.onrender.com`
...
Example:
`REACT_APP_API_BASE_URL=https://vaccination-app-j1kq.onrender.com`
...
Use this live demo link for resume and interviews:
`https://vaccination-frontend.onrender.com`
